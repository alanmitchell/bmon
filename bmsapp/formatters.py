...
def sage_limits_sensor_formatter(coded_value):
    ...
    value_list = _bitmask_to_list(coded_value, limits_bitmask_dictionary)
...
def sage_alarm_reason_formatter(coded_value):
    alarm_reason_dictionary = {0: 'None', 1: 'Lockout (see Lockout Code)', 2: 'Alert (see Table 11)', 3: 'Other'}
    if coded_value in alarm_reason_dictionary:
        return alarm_reason_dictionary[coded_value]
    else:
        return 'Unknown (invalid value)'


def sage_demand_source_formatter(coded_value):
    demand_source_dictionary = {0: 'Unknown',
                                1: 'No source demand',
                                2: 'CH',
                                3: 'DHW',
                                4: 'Lead Lag slave',
    ...
    if coded_value in demand_source_dictionary:
        return demand_source_dictionary[coded_value]
    else:
        return 'Unknown (invalid value)'


def sage_lockout_code_formatter(coded_value):
    lockout_code_dictionary = {0: 'None',
    ...
    if coded_value in lockout_code_dictionary:
        return lockout_code_dictionary[coded_value]
    else:
        return 'Unknown (invalid value)'


def sage_alert_code_formatter(coded_value):
    alert_code_dictionary = {0: 'None (No alert)',
    ...
    if coded_value in alert_code_dictionary:
        return alert_code_dictionary[coded_value]
    else:
        return 'Unknown (invalid value)'
