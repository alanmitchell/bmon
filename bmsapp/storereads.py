...
def store_many(req_data):
    ...
    holding the reading information.  Currently, two formats for 'req_data' are
    supported.  One format is used by the Mini-Monitor, and a second is used by
    Webhhook calls generated by Particle Photon and Electron devices; this format
    is identified by the existence of a 'format' key in 'req_data' having the value
    'particle'.
