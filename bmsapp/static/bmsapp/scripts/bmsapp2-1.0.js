...
(function() {
  var REFRESH_MS, SENSOR_MULTI_CONFIG, inputs_changed, process_chart_change, set_visibility, test, update_bldg_list, update_chart_sensor_lists, update_results, _auto_recalc, _refresh_timer;

  window.AN = {};

  test = function() {
    return window.AN.plot_sensor(2, 189);
  };
