...
(function() {
  ...
  addSparkline = function(jqParent, g_info) {
    ...
    jqParent.append("<div id=\"" + widgetID + "\" class=\"dash-widget\"> <div class=\"widget-title\">" + g_info.title + "</div> <div class=\"dash-graph\"></div> <div class=\"value-label\">" + g_info.value_label + "</div> </div>");
    jqWidget = $("#" + widgetID);
