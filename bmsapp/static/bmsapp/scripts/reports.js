...
(function () {
  ...
  update_results = function () {
    ...
    return $.getJSON($("#BaseURL").text() + "reports/results/", serializedInputs()).done(function (results) {
      ...
      $("#results .bmon-sensor-id").attr("data-toggle", "tooltip").attr("data-original-title", "Click to copy Sensor ID to Clipboard").css("cursor", "pointer").tooltip().click(function () {
        var target;
        target = this;
